...
var game_data: Dictionary = {
	...
	"highest_score": highest_score  # Added highest_score with a default value
}
...
func load_game() -> bool:
	...
	if not FileAccess.file_exists(SAVE_FILE):
		...
		game_data = {
			...
			"levels": {},
			"highest_score": highest_score  # Initialize highest_score
		}
		save_game()
	...
	var required_fields = {
		...
		"last_health_restore": Time.get_unix_time_from_system(),
		"levels": {},
		"highest_score": highest_score  # Ensure highest_score is initialized
	}
